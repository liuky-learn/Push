...
class SendMessage():
    def __init__(self):
        ...
        sr = self.get_sr()
        body =rq+"\n"+tq+"\n"+jnr+"\n"+sr;
        self.dataJson ={"first":"哈喽,小王八蛋！",
                        "body":body+" ",
                        "remark":self.get_qh()[random.randint(0, len(self.get_qh())-2)]+" "
                        }
        self.appID = 'wxf143e83cd10d63c1'
        self.appsecret = '614524baf032423d1e82700af7c7b93c'
        self.template_id = 'jfwDcJQeHSscLcGbyqT6oub9mqoocmIQTHJI7RszhmU'
    ...
    def get_qh(self):
        qhStr="";
        file_object1 = open("C:\APP\qh.txt", 'r',encoding="utf-8")
        try:
            while True:
    ...
    def get_sr(self):
        ...
        oneDay = ZhDate(today.year, 5, 10).to_datetime()
    ...
    def get_jnr(self):
        today = datetime.datetime.now()
        data_str = today.strftime('%Y-%m-%d')
        oneDay = ZhDate(2022, 7, 1).to_datetime()
